document.addEventListener('DOMContentLoaded', () => {
  ...
  const languagePairs = [
    ...
    ['.experience-item-v2secure .timeline-body > p:nth-of-type(4)', 'Tìm hiểu các giải pháp an ninh mạng gồm WAF, SIEM và EDR để hiểu rõ hơn bài toán sản phẩm và bối cảnh kỹ thuật của công ty.', 'Studied WAF, SIEM and EDR solutions to better understand the product problem and its technical context.'],
